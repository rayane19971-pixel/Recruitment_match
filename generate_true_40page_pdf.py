...
def build_true_40page_pdf():
    ...
    # =========================================================================
    story.append(Paragraph("SOMMAIRE GÉNÉRAL PAGO-CENTRÉ (PAGE 1 À 40)", h1_style))
    ...
    toc_items = [
        ...
        ("PAGE 2", "Sommaire général paginé du dossier de projet annuel"),
        ("PAGES 3 - 4", "PARTIE 1.b — Contexte & Objectifs Stratégiques OL (Analyse SWOT)"),
        ("PAGES 5 - 19", "PARTIE 1.c — Analyse des Besoins, Veille, MoSCoW, Risques & RSE"),
        ("PAGES 20 - 29", "PARTIE 1.d — Cahier des Charges, Fonctionnalités, Gantt & Budget"),
        ("PAGES 30 - 31", "PARTIE 2.a — Architecture Technique Modulaire & Data ETL (Bloc 4)"),
        ("PAGES 32 - 33", "PARTIE 2.b — Maquettes & Prototypes UX/UI Glassmorphism OL (Bloc 4)"),
        ("PAGES 34 - 35", "PARTIE 2.c — Développement Front-End React 18, Canvas SVG & Mobile (Bloc 4)"),
        ("PAGES 36 - 38", "PARTIE 2.d — Développement Back-End FastAPI, SQLite & Algorithme k-NN (Bloc 4)"),
        ("PAGES 39 - 40", "PARTIE 2.e, f, g — Tests, RGPD, Accessibilité W3C, Maintenance & Bilan (Bloc 4)")
    ]
    ...
    # =========================================================================
    # PAGES 3 À 29 : PREMIÈRE PARTIE - ANALYSE DES BESOINS
    # =========================================================================
    pages_p1 = [
    ...
    print(f"PDF vérifié et généré avec succès dans : {pdf_path}")

if __name__ == "__main__":
    build_true_40page_pdf()
